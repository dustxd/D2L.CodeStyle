...
namespace SpecTests {
	...
	public sealed class Classes {
		...
		[ImmutableBaseClass]
		public sealed class ClassMarkedImmutableBaseClassImplementingRegularInterface : Interfaces.RegularInterface { }
		...
		public sealed class ClassMarkedImmutable {
			...
			RegularClass /* MemberIsNotReadOnly(Field, m_writableMutableField, ClassMarkedImmutable) */ m_writableMutableField /**/ = new RegularClass();

			readonly RegularClass /* NonImmutableTypeHeldByImmutable(Class, RegularClass, ) */ m_readonlyMutableField /**/ = new RegularClass();

			RegularClass /* NonImmutableTypeHeldByImmutable(Class, RegularClass, ) */ AutoImplementedMutableProperty /**/ { get; } = new RegularClass();

			RegularClass ImplementedMutableProperty { get { return new RegularClass(); } }



			static object m_staticWritableMutableFieldHeldAsSuper = new RegularClass();

			static readonly object m_staticReadOnlyMutableFieldHeldAsSuper = new RegularClass();

			object /* MemberIsNotReadOnly(Field, m_writableMutableFieldHeldAsSuper, ClassMarkedImmutable) */ m_writableMutableFieldHeldAsSuper /**/ = new RegularClass();

			// Cant write this expectation right now
			// readonly object /* NonImmutableTypeHeldByImmutable(Class, RegularClass, (or [ImmutableBaseClass])) */ m_readonlyMutableFieldHeldAsSuper /**/ = new RegularClass();

			// Cant write this expectation right now
			// object /* NonImmutableTypeHeldByImmutable(Class, RegularClass, (or [ImmutableBaseClass])) */ AutoImplementedMutablePropertyHeldAsSuper /**/ { get; } = new RegularClass();

			object ImplementedMutablePropertyHeldAsSuper { get { return new RegularClass(); } }
